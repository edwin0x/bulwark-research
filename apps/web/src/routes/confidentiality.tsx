    ...
    <div ref={revealRef}>
      ...
      <section className="relative pt-40 pb-24 px-6 overflow-hidden">
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          ...
          >
            Your ideas are <span className="text-secondary">sacred</span>.
          </h1>
          <p
            className="text-lg text-secondary max-w-xl mx-auto animate-fade-up"
      ...
      <section className="relative py-24 px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {/* Card 1 */}
              <div className="bp-card p-8 reveal delay-1">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-display text-xl font-semibold mb-3">End-to-End Encryption</h3>
              ...
              {/* Card 2 */}
              <div className="bp-card p-8 reveal delay-2">
                <div className="flex items-start gap-4">
                  <svg className="w-6 h-6 text-emerald flex-shrink-0 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636" />
                  </svg>
                  <div>
                    <h3 className="font-display text-xl font-semibold mb-3">No Model Training</h3>
                    <p className="text-secondary leading-relaxed">
              ...
              {/* Card 3 */}
              <div className="bp-card p-8 reveal delay-3">
                <div className="flex items-start gap-4">
                  <svg className="w-6 h-6 text-emerald flex-shrink-0 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                  </svg>
                  <div>
                    <h3 className="font-display text-xl font-semibold mb-3">No Third-Party Sharing</h3>
                    <p className="text-secondary leading-relaxed">
              ...
              {/* Card 4 */}
              <div className="bp-card p-8 reveal delay-4">
                <div className="flex items-start gap-4">
                  <svg className="w-6 h-6 text-emerald flex-shrink-0 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-3m-1 4l-3 3m0 0l-3-3m3 3V4" />
                  </svg>
                  <div>
                    <h3 className="font-display text-xl font-semibold mb-3">Full Data Control</h3>
                    <p className="text-secondary leading-relaxed">
				...
				<div className="max-w-4xl mx-auto">
					<div className="text-center mb-16">
						...
						<h2 className="section-title text-3xl sm:text-4xl reveal delay-1">
							How we <span className="text-secondary">differ.</span>
						</h2>
					</div>
					...
					<div className="space-y-8">
						<div className="reveal delay-2">
							...
							<p className="text-dim italic pl-4 border-l-2 border-border mt-2 mb-4">
								"We may use your data to improve our services"
							</p>
							<span className="font-mono text-[10px] text-signal uppercase tracking-widest">Bulwark</span>
							<p className="text-ink font-medium pl-4 border-l-2 border-signal mt-2">
			...
			<section className="relative py-24 px-6">
				<div className="max-w-3xl mx-auto text-center">
					<div className="bp-card p-12 reveal">
						...
						<a
							...
							className="inline-flex items-center gap-2 text-signal hover:text-amber transition-colors font-mono text-sm"
						>
			...
			<section className="relative py-32 px-6 overflow-hidden">
				<div className="relative z-10 max-w-2xl mx-auto text-center">
					...
					<a href="/#hero-input" className="btn-signal px-8 py-3.5 text-sm reveal delay-2">
