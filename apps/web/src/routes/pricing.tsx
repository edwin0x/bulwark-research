...
export const Route = createFileRoute('/pricing')({
  head: () => ({
    meta: [
      ...
      {
        name: 'description',
        content: 'Big 4 rigor at founder-friendly prices. Choose the plan that fits your validation needs.',
      },
    ...
    <div ref={revealRef}>
      ...
      <section className="relative py-24 px-6">
        <div className="relative z-10 max-w-2xl mx-auto text-center">
          <h2 className="section-title text-2xl sm:text-3xl mb-4 reveal">
            Still not sure?
          </h2>
