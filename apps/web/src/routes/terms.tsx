    ...
    <div ref={revealRef}>
      ...
      <section className="relative pt-40 pb-24 px-6 overflow-hidden">
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          ...
          <p
            className="text-lg text-secondary animate-fade-up"
      ...
      <section className="relative py-24 px-6">
        <div className="max-w-3xl mx-auto space-y-12">
              ...
              <div className="reveal delay-1 space-y-4">
                <h3 className="text-ink font-semibold text-lg mb-3">
                  Acceptance of Terms
                </h3>
              ...
              <div className="reveal delay-9 space-y-4">
                ...
                <p className="text-secondary leading-relaxed">
                  ...
                  <a href="mailto:hello@bulwark.research" className="text-signal hover:underline">
