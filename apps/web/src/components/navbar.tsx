    ...
    <nav className="fixed top-0 left-0 right-0 z-50 border-b border-white/5 bg-ink/80 backdrop-blur-xl">
      <div className="mx-auto max-w-6xl px-6 flex items-center justify-between h-16">
        ...
        <div className="hidden md:flex items-center gap-8 text-sm text-muted">
          <a href={`${hashPrefix}#how-it-works`} className="hover:text-paper transition-colors duration-200">
            How it works
          </a>
          <a href={`${hashPrefix}#what-you-get`} className="hover:text-paper transition-colors duration-200">
            What you get
          </a>
          <Link
            to="/pricing"
        ...
        <div className="flex items-center gap-4">
          <Link to="/pricing" className="hidden sm:inline-block text-sm text-muted hover:text-paper transition-colors">
            Sign in
          </Link>
