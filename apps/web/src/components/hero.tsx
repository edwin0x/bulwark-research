export function Hero() {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center px-6 pt-24 pb-16 overflow-hidden">
      ...
      <div className="bg-grid absolute inset-0 pointer-events-none opacity-40"></div>
      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        {/* Overline */}
        <div className="overline-divider max-w-sm mx-auto mb-6 animate-fade-in" style={{ animationDelay: '0.1s' }}>
          The Last Human Moat
        </div>

        {/* Headline */}
        <h1 className="section-title text-4xl sm:text-5xl md:text-6xl lg:text-7xl mb-6 animate-fade-up" style={{ animationDelay: '0.2s' }}>
          Everyone can build.<br />
          Few know <span className="italic font-accent text-gradient-warm">what</span> to build.
        </h1>

        {/* Subheadline */}
        <p className="text-lg md:text-xl text-muted max-w-xl mx-auto mb-10 animate-fade-up" style={{ animationDelay: '0.35s' }}>
          AI made execution cheap. Taste and judgment are the last moat.
          An agent swarm runs internet-scale research on your idea and delivers a Big 4-quality dossier to your inbox — in 30 minutes.
        </p>
        ...
        <div id="hero-input" className="animate-fade-up" style={{ animationDelay: '0.5s' }}>
          <div className="relative max-w-xl mx-auto">
            <div className="flex flex-col sm:flex-row gap-3 p-2 rounded-2xl border border-ink-border bg-ink-light/60 backdrop-blur-sm">
              ...
              />
              <button type="button" className="btn-glow px-7 py-3.5 text-sm font-semibold whitespace-nowrap">
                Validate Now →
              </button>
            </div>
        ...
        <div className="mt-16 animate-fade-up" style={{ animationDelay: '0.65s' }}>
          <p className="text-[10px] font-mono uppercase tracking-[0.2em] text-dim mb-5">Research infrastructure powered by</p>
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-fade-in" style={{ animationDelay: '1s' }}>
        <div className="w-5 h-8 rounded-full border border-ink-border flex items-start justify-center p-1.5">
          <div className="w-1 h-2 rounded-full bg-muted animate-pulse"></div>
        </div>
      </div>
    </section>
  )
